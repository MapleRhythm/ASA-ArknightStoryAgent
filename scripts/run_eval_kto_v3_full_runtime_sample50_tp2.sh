...
KTO_LORA="${KTO_LORA:-$ROOT_DIR/model/lora/opd_kto_full_chain_sample500_deepseek_v3_qwen35_4b_lr3e6_beta001_ref_sft_epoch1}"
FULL_RUNTIME="${FULL_RUNTIME:-$ROOT_DIR/model/merged/opd_kto_full_chain_sample500_deepseek_v3_qwen35_4b_full_runtime}"
OUTPUT="${OUTPUT:-$ROOT_DIR/outputs/eval_multiround_retrieval/kto_v3_full_runtime_sample50_tp2.json}"
...
"$PYTHON_BIN" scripts/evaluate_multiround_retrieval_recall.py \
  ...
  --top-ks 1,5,10,20,50 \
  --progress-every 5 \
  --tag kto_v3_full_runtime_sample50_tp2
