...
LORA_PATH="${LORA_PATH:-$ROOT_DIR/model/lora/teacher_v2_plus_prompt_supplement_v2_qwen35_4b}"
MERGED_DIR="${MERGED_DIR:-$ROOT_DIR/model/merged/teacher_v2_plus_prompt_supplement_v2_qwen35_4b}"
F16_GGUF="${F16_GGUF:-$ROOT_DIR/model/gguf/teacher_v2_plus_prompt_supplement_v2_qwen35_4b-merged-f16.gguf}"
Q4_GGUF="${Q4_GGUF:-$ROOT_DIR/model/gguf/teacher_v2_plus_prompt_supplement_v2_qwen35_4b-merged-q4_k_m.gguf}"
